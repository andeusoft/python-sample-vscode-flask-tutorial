[![Build Status](https://dev.azure.com/andreadascoli/andreadascoli/_apis/build/status%2Fandeusoft.python-sample-vscode-flask-tutorial?branchName=main)](https://dev.azure.com/andreadascoli/andreadascoli/_build/latest?definitionId=1&branchName=main)
